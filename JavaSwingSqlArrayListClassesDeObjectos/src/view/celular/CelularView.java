...
public class CelularView implements ActionListener, MouseListener {
	...
	private void initialize() {
		...
		comboBoxAnoDeFabrico.setFont(new Font("Caladea", Font.BOLD, 14));
		comboBoxAnoDeFabrico.setForeground(new Color(0, 70, 67));
		comboBoxAnoDeFabrico.setModel(new DefaultComboBoxModel(new String[] { "2026", "2025", "2024", "2023", "2022",
...
//		comboBoxMarca.removeAllItems();
//		for(Modelo modelos : listaDeModelos) {
//			if(marca != null && marca.equals(modelos.getMarca())) {
//				comboBoxModelo.addItem(modelos.getModelo());
//			}
//		}
//	}
